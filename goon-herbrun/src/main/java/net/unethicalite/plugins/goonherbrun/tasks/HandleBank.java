...
import net.unethicalite.plugins.goonherbrun.Location;
import net.unethicalite.plugins.goonherbrun.utils.Config;
import net.unethicalite.plugins.goonherbrun.utils.Constants;
import net.unethicalite.plugins.goonherbrun.utils.api.ChaosBank;
...
public class HandleBank extends BankTask {
    ...
    @Inject
    private GoonHerbRunPlugin plugin;
    ...
    private void withdrawTeleportItems() {
        ...
        for (Location location : Location.values()) {
            if (!location.isEnabled(config)) { //here asdf
                continue;
            }
