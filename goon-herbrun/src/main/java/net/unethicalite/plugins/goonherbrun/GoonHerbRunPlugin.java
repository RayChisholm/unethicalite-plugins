...
import net.unethicalite.plugins.goonherbrun.tasks.*;
import net.unethicalite.plugins.goonherbrun.utils.TickScript;
...
public class GoonHerbRunPlugin extends TickScript implements KeyListener {
